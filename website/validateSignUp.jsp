...
<%
	...
	try {                     
		...
		String insertMemberQuery = "INSERT INTO members('email', 'username', 'password', 'first_name', 'last_name', 'country', 'address', 'postal_code') VALUES(?, ?, ?, ?, ?, ?, ?, ?)";    
