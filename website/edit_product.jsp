      ...
      <form class="mx-auto col-8 p-5 bo-rad-10" style="background-color: rgb(255, 255, 255)">
        ...
        <div class="form-row">
          <div class="form-group row col-md-12">
            ...
            <input type="text" class="form-control col-10" id="inputProductId" placeholder="Product Id" value="X" readonly required>
          </div>
          ...
          <div class="form-group col-md-12">
            ...
            <textarea type="text" class="form-control" id="inputProductDescription" placeholder="Product description" required></textarea>
          </div>
